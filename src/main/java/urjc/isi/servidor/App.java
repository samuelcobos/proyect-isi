...
public class App 
{
	...
	ClassNotFoundException, SQLException {
		...
		post("/alumno", (req, res) -> {
			...
			alumno alumnoObject = new alumno(nombre, 4568, ip);
		...
		post("/finalizar", (req, res) -> 
			"<h1>Ha finalizado el examen correctamente</h1>"
		);
		...
		post("/:random", (req, res) -> {
			...
			//-Añadido
			String result ="<h1> El examen con ID "+id_examen+" se ha iniciado con el numero generado: </h1>"
